  ...
  constructor(){
    ...
    this.state = {
        movies: [
            ...
            users: [
                {id: 0, name: "Issa", color: "#5f70d8", budget: 10, rented:[]},
                {id: 1, name: "Aysam", color: "#6df8ffde", budget: 10, rented:[]},
                {id: 2, name: "Eden", color: "#34f649", budget: 10, rented:[]},
                {id: 3, name: "Ali", color: "#ffeb3b", budget: 10, rented:[]}
            ],
            correntUser: false
